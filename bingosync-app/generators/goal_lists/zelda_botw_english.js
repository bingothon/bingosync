...
bingoList[8] = [
    ...
    { name: "Obtain Great Flameblade from Eldin Leviathin", types: ["Equipment","Eldin","Cold Resistance"] }
];
bingoList[9] = [
...
bingoList[13] = [
    ...
    { name: "Resurrect a Horse", types: ["Mount","Faron","Ruppe","Malanya"] },
...
bingoList[17] = [
    ...
    { name: "3 Aparatus Shrines", types: ["Shrine"] },
...
bingoList[25] = [
    ...
    { name: "Kill 15 Hinox/Stallnox", types: ["Miniboss","Hinox"] },
    { name: "Kill 15 Talus", types: ["Miniboss","Talus","Gems"] },
    { name: "Kill 10 Lynel", types: ["Miniboss","Lynel"] },

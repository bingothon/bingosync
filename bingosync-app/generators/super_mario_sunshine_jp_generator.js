...
bingoList[2] = [
    { name: "ピンナパークの青コイン12枚", types: ["Pinna_Blues", "Pinna_10", "Pinna_30"] },
...
bingoList[3] = [
    ...
    { name: "M字から青コイン21枚", types: ["M_Graffiti", "Ricco_M"] }
];
bingoList[4] = [
...
bingoList[5] = [
    ...
    { name: "ピンナパークの青コイン16枚", types: ["Pinna_Blues", "Fast_20", "Pinna_Early", "Pinna_30", "Pinna_Shines"] },
...
bingoList[6] = [
    ...
    { name: "リコハーバーの青コイン24枚", types: ["Ricco_Blues", "Blue_Enemies", "Ricco_Early", "Ricco_30", "Ricco_Shines"] },
    { name: "マンマビーチの100枚コイン", types: ["Gelato_100s", "Gelato_Early"] },
    { name: "ビアンコヒルズの100枚コイン", types: ["Bianco_100s", "Bianco_Early"] },
    { name: "NPCの青コイン7枚 (モンテ6以外)", types: ["Fruit_Ladies", "Plaza_Blues", "NPC_Blues"] },
...
bingoList[7] = [
    ...
    { name: "ストーリー2で100枚コイン", types: ["Secret_100s"] },
...
bingoList[8] = [
    ...
    { name: "チョロプーのストーリーでシャイン4枚", types: ["Noki_Early", "Pinna_Shines"] },
...
bingoList[9] = [
    ...
    { name: "敵から青コイン6枚", types: ["Blue_Enemies", "Ricco_Top", "Ricco_Blues", "Ricco_Early", "XBoss_Shines", "M_Graffiti"] },
...
bingoList[10] = [
    { name: "青コイン合計40枚", types: ["Ricco_Blues", "Pinna_Blues", "Bianco_Blues", "Pianta_Blues", "Noki_Blues", "Plaza_Blues", "Gelato_Blues", "Sirena_Blues", "XTotal_Blues", "Blue_30"] },
    { name: "青コイン合計45枚", types: ["Ricco_Blues", "Pinna_Blues", "Bianco_Blues", "Pianta_Blues", "Noki_Blues", "Plaza_Blues", "Gelato_Blues", "XTotal_Blues", "Blue_30"] },
...
bingoList[11] = [
    ...
    { name: "3ステージでヨッシーに乗る", types: ["Pinna_Yoshi", "Three_Yoshi", "Pianta_Yoshi", "Sirena_Yoshi", "Pinna_Shines", "Bianco_Yoshi", "Ricco_Yoshi"] },
...
bingoList[12] = [
    ...
    { name: "ヒップドロップ5種類のボタン", types: ["Hidden_Shines", "Gelato_Hidden", "Pinna_Hoverless", "Ricco_6", "Ricco_Hidden"] }
];
bingoList[13] = [
    { name: "赤コインのシャイン6枚", types: ["Red_Shines", "Hidden_Shines", "Low_Reds"] },
    { name: "リコハーバーの隠しシャイン2枚", types: ["Ricco_Hidden", "Ricco_Early", "Ricco_6"] },
    { name: "1ステージから隠しシャイン2枚（ドルピックタウンマンマビーチ以外）", types: ["Ricco_Hidden", "Ricco_Early", "Ricco_6"] },
    ...
    { name: "NPCのモンテからシャイン5枚", types: ["Plaza_Shines", "Shadow_Plaza", "Hidden_Plaza", "Plaza_Mix_Up", "Pianta_8", "Plaza_Secret", "Plaza_G8", "Plaza_Rocket", "LateS_Plaza", "HighBlue_Plaza"] },
...
bingoList[14] = [
    ...
    { name: "3ステージで青コイン20枚（ドルピックタウン以外）", types: ["XTotal_Blues", "High_Blues"] },
...
bingoList[15] = [
    { name: "NPCの青コイン9枚", types: ["Pianta_6", "LateP_LateS", "Noki_Early", "Fruit_Ladies", "NPC_Blues"] },
    { name: "残機30", types: ["X_Lives", "Pianta_Lives", "100_Lives", "LateN_Lives"] },
    { name: "残機35", types: ["X_Lives", "Pianta_Lives", "100_Lives", "LateN_Lives"] },
    { name: "ビアンコヒルズの青コイン23枚", types: ["Bianco_30", "Bianco_Early", "Bianco_Blues"] },
    { name: "ヒミツステージのシャイン5枚", types: ["Secret_Shines", "Hidden_Shines", "Secret_Count", "Plaza_Secret", "Ricco_Secret", "Pianta_Secret", "Gelato_Secret"] },
    { name: "ヒミツステージのシャイン6枚", types: ["Secret_Shines", "Hidden_Shines", "Secret_Count", "Plaza_Secret", "Ricco_Secret", "Pianta_Secret", "Gelato_Secret"] },
...
bingoList[17] = [
    ...
    { name: "ドルピックでシャイン15枚(青換金可)", types: ["Plaza_Shines", "Shadow_Plaza", "Plaza_Mix_Up", "Hidden_Plaza", "Pianta_8", "Plaza_Secret", "Plaza_Rocket", "LateS_Plaza", "Noki_100s"] },
...
bingoList[18] = [
    ...
    { name: "ヒミツ内部でシャイン8枚", types: ["Bianco_Hidden", "Bianco_Late", "Blue_Bird", "Bianco_Yoshi", "Bianco_Shines"] },
...
bingoList[20] = [
    ...
    { name: "7回土管に入りその先でシャイン回収", types: ["Pianta_8", "Sirena_5", "Pianta_Shadow", "Pianta_6", "LateP_LateS", "NPC_Blues"] },
    { name: "ミニボスのシャイン4枚", types: ["XBoss_Shines", "Unique_Boss", "Bianco_Boss", "Pinna_Boss", "Ricco_Boss", "Sirena_Early", "Noki_Boss"] },
...
bingoList[21] = [
    ...
    { name: "赤コインのストーリーのシャイン4枚", types: ["Red_Shines"] },
...
bingoList[22] = [
    ...
    { name: "シャイン30枚", types: ["Total_Shines", "X_Lives", "Slow_Awful"] },
...
bingoList[23] = [
    ...
    { name: "マーレ2ジャンプ禁止", types: ["Noki_2", "Jumpless"] },
    { name: "シレナのカジノの青コイン全て取得", types: ["Sirena_5", "Sirena_Late"] }
];
bingoList[24] = [
    { name: "1ステージからヒミツステージのシャイン2枚（ピンナパーク以外）", types: ["Secret_Shines", "Secret_Count", "Plaza_Secret", "Bianco_Secret", "Sirena_Secret"] },
